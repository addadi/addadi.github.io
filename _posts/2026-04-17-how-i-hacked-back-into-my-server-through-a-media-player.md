...
I have friends nearby, but you can't walk someone through SSH debugging on a headless server over the phone.
...
I had an idea: write a Jellyfin plugin that runs shell commands and reports back the output.
